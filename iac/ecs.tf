  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "${var.ecr_registry}/${var.image_name1}:${var.image_tag}"
      essential = true
      ...
      dependsOn   = [
        {
        containerName = "${var.project_name}-${var.environment}-postgres-container"
        condition     = "START"
        }
      ]
    ...
    },
    {
      ...
      image     = "${var.ecr_registry}/${var.image_name2}:${var.image_tag}"
      essential = true
...
resource "aws_ecs_service" "ecs_service" {
  ...
  load_balancer {
    ...
    container_name   = "${var.project_name}-${var.environment}-api-container"
    container_port   = 80
  }
}
